...
class Command(BaseCommand):
    ...
    def _seed_teachers(self):
        self.stdout.write('\n[1/5] Membuat pengajar (dosen01 - dosen20)...')
        ...
        # Buat UserProfile untuk semua instruktur/dosen
        for t in teachers:
            UserProfile.objects.get_or_create(user=t, defaults={'role': 'instructor'})
    ...
    def _seed_students(self):
        self.stdout.write('\n[2/5] Membuat mahasiswa (mhs001 - mhs080)...')
        ...
        # Buat UserProfile untuk semua siswa/mahasiswa
        for s in students:
            UserProfile.objects.get_or_create(user=s, defaults={'role': 'student'})
